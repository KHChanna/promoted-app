          ...
          <article class="card-body">
            ...
            <form method="POST" action="{{ route('login.submit') }}">
              ...
              <div class="form-group input-icon has-danger">
                ...
                <input id="email" placeholder="Phone number" type="text" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required autofocus>
              ...
              <div class="form-group input-icon">
                ...
                <input id="password" placeholder="Password" type="password" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="password" required>
