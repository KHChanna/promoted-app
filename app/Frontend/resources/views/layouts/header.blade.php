...
<div class="container">
  ...
  <div class="collapse navbar-collapse" id="navbarTop">
    ...
    <ul class="navbar-nav">
    <li><a href="#" class="nav-link"> Become a Seller </a></li>
		<li><a href="{{route('my.account')}}" class="nav-link"> My Account </a></li>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="main_nav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link pl-0" href="{{ route('search')}}"> <strong>All Categories</strong></a>
        </li>

        @php

          $categories = App\Frontend\Models\Category::all();
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ route('search', ['cat'=>$cat->id])}}">{{ $cat->default_name }}</a>
        </li>
